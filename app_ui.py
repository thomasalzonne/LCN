...
"        ")
        ...
        self.gettemperature = QtWidgets.QPushButton(self.tab3d)
        self.gettemperature.setMinimumSize(QtCore.QSize(300, 50))
        self.gettemperature.setObjectName("gettemperature")
        self.horizontalLayout_24.addWidget(self.gettemperature)
        self.stopgettemp = QtWidgets.QPushButton(self.tab3d)
        self.stopgettemp.setMinimumSize(QtCore.QSize(50, 50))
        self.stopgettemp.setMaximumSize(QtCore.QSize(50, 16777215))
        self.stopgettemp.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("assets/stop-button.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.stopgettemp.setIcon(icon5)
        self.stopgettemp.setIconSize(QtCore.QSize(45, 45))
        self.stopgettemp.setObjectName("stopgettemp")
        self.horizontalLayout_24.addWidget(self.stopgettemp)
        ...
        self.stopetemp = QtWidgets.QPushButton(self.tab3d)
        self.stopetemp.setMinimumSize(QtCore.QSize(50, 50))
        self.stopetemp.setMaximumSize(QtCore.QSize(50, 50))
        self.stopetemp.setText("")
        self.stopetemp.setIcon(icon5)
        self.stopetemp.setIconSize(QtCore.QSize(45, 45))
        self.stopetemp.setObjectName("stopetemp")
        self.horizontalLayout_8.addWidget(self.stopetemp)
        ...
        self.startetemp = QtWidgets.QPushButton(self.tab3d)
        self.startetemp.setMinimumSize(QtCore.QSize(50, 50))
        self.startetemp.setMaximumSize(QtCore.QSize(50, 50))
        self.startetemp.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("assets/send.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.startetemp.setIcon(icon6)
        self.startetemp.setIconSize(QtCore.QSize(45, 45))
        self.startetemp.setObjectName("startetemp")
        self.horizontalLayout_8.addWidget(self.startetemp)
        ...
        self.extrudortemperature = QtWidgets.QLabel(self.tab3d)
        self.extrudortemperature.setMinimumSize(QtCore.QSize(0, 20))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.extrudortemperature.setFont(font)
        self.extrudortemperature.setText("")
        self.extrudortemperature.setAlignment(QtCore.Qt.AlignCenter)
        self.extrudortemperature.setObjectName("extrudortemperature")
        self.verticalLayout_5.addWidget(self.extrudortemperature)
        ...
        self.stopbedtemp = QtWidgets.QPushButton(self.tab3d)
        self.stopbedtemp.setMinimumSize(QtCore.QSize(50, 50))
        self.stopbedtemp.setMaximumSize(QtCore.QSize(50, 50))
        self.stopbedtemp.setText("")
        self.stopbedtemp.setIcon(icon5)
        self.stopbedtemp.setIconSize(QtCore.QSize(45, 45))
        self.stopbedtemp.setObjectName("stopbedtemp")
        self.horizontalLayout_9.addWidget(self.stopbedtemp)
        ...
        self.startbedtemp = QtWidgets.QPushButton(self.tab3d)
        self.startbedtemp.setMinimumSize(QtCore.QSize(50, 50))
        self.startbedtemp.setMaximumSize(QtCore.QSize(50, 50))
        self.startbedtemp.setText("")
        self.startbedtemp.setIcon(icon6)
        self.startbedtemp.setIconSize(QtCore.QSize(45, 45))
        self.startbedtemp.setObjectName("startbedtemp")
        self.horizontalLayout_9.addWidget(self.startbedtemp)
        ...
        self.bedtemperature = QtWidgets.QLabel(self.tab3d)
        self.bedtemperature.setMinimumSize(QtCore.QSize(0, 20))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.bedtemperature.setFont(font)
        self.bedtemperature.setText("")
        self.bedtemperature.setAlignment(QtCore.Qt.AlignCenter)
        self.bedtemperature.setObjectName("bedtemperature")
        self.verticalLayout_4.addWidget(self.bedtemperature)
        ...
        self.verticalLayout_10 = QtWidgets.QVBoxLayout(self.tablaser)
        self.verticalLayout_10.setObjectName("verticalLayout_10")
        self.sliderlaser = QtWidgets.QSlider(self.tablaser)
        self.sliderlaser.setMinimumSize(QtCore.QSize(0, 70))
        self.sliderlaser.setStyleSheet("QSlider::groove:horizontal {\n"
...
"    border-radius: 3px;\n"
"}")
        self.sliderlaser.setMaximum(100)
        self.sliderlaser.setOrientation(QtCore.Qt.Horizontal)
        self.sliderlaser.setObjectName("sliderlaser")
        self.verticalLayout_10.addWidget(self.sliderlaser)
        self.laserslidervalue = QtWidgets.QLabel(self.tablaser)
        self.laserslidervalue.setAlignment(QtCore.Qt.AlignCenter)
        self.laserslidervalue.setObjectName("laserslidervalue")
        self.verticalLayout_10.addWidget(self.laserslidervalue)
        self.pushButton = QtWidgets.QPushButton(self.tablaser)
        ...
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.tabfraiseuse)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.fraiseuseslider = QtWidgets.QSlider(self.tabfraiseuse)
        self.fraiseuseslider.setMinimumSize(QtCore.QSize(0, 70))
        self.fraiseuseslider.setStyleSheet("QSlider::groove:horizontal {\n"
"    border: 1px solid #999999;\n"
"    height: 8px; /* the groove expands to the size of the slider by default. by giving it a height, it has a fixed size */\n"
"    background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #B1B1B1, stop:1 #c4c4c4);\n"
"    margin: 2px 0;\n"
...
"    border-radius: 3px;\n"
"}")
        self.fraiseuseslider.setOrientation(QtCore.Qt.Horizontal)
        self.fraiseuseslider.setObjectName("fraiseuseslider")
        self.verticalLayout_9.addWidget(self.fraiseuseslider)
        self.fraiseuseslidervalue = QtWidgets.QLabel(self.tabfraiseuse)
        self.fraiseuseslidervalue.setAlignment(QtCore.Qt.AlignCenter)
        self.fraiseuseslidervalue.setObjectName("fraiseuseslidervalue")
        self.verticalLayout_9.addWidget(self.fraiseuseslidervalue)
        self.onoff = QtWidgets.QPushButton(self.tabfraiseuse)
        self.onoff.setMinimumSize(QtCore.QSize(0, 100))
        self.onoff.setObjectName("onoff")
        self.verticalLayout_9.addWidget(self.onoff)
        self.tabWidget.addTab(self.tabfraiseuse, "")
        self.tab = QtWidgets.QWidget()
        self.tab.setObjectName("tab")
        self.loadfiles = QtWidgets.QPushButton(self.tab)
        self.loadfiles.setGeometry(QtCore.QRect(150, 50, 151, 41))
        self.loadfiles.setObjectName("loadfiles")
        self.savebutton = QtWidgets.QPushButton(self.tab)
        self.savebutton.setGeometry(QtCore.QRect(300, 50, 181, 41))
        self.savebutton.setObjectName("savebutton")
        self.gcodefile = QtWidgets.QPlainTextEdit(self.tab)
        self.gcodefile.setGeometry(QtCore.QRect(150, 90, 681, 791))
        self.gcodefile.setObjectName("gcodefile")
        self.launchprog = QtWidgets.QPushButton(self.tab)
        self.launchprog.setGeometry(QtCore.QRect(480, 50, 271, 41))
        self.launchprog.setObjectName("launchprog")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.gettemperature.setText(_translate("MainWindow", "Obtenir la température"))
        ...
        self.laserslidervalue.setText(_translate("MainWindow", "TextLabel"))
        ...
        self.fraiseuseslidervalue.setText(_translate("MainWindow", "TextLabel"))
        ...
        self.loadfiles.setText(_translate("MainWindow", "Charger"))
        self.savebutton.setText(_translate("MainWindow", "Save"))
        self.launchprog.setText(_translate("MainWindow", "Lancer programme"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Charger fichier"))
