...
"max-height:100px;")
        ...
        self.radio0_1mm = QtWidgets.QRadioButton(self.centralwidget)
        self.radio0_1mm.setMinimumSize(QtCore.QSize(0, 25))
        self.radio0_1mm.setStyleSheet("")
        self.radio0_1mm.setObjectName("radio0_1mm")
        self.gridLayout.addWidget(self.radio0_1mm, 0, 0, 1, 1)
        self.radio1mm = QtWidgets.QRadioButton(self.centralwidget)
        self.radio1mm.setMinimumSize(QtCore.QSize(0, 25))
        self.radio1mm.setObjectName("radio1mm")
        self.gridLayout.addWidget(self.radio1mm, 1, 0, 1, 1)
        self.radio10mm = QtWidgets.QRadioButton(self.centralwidget)
        self.radio10mm.setMinimumSize(QtCore.QSize(0, 25))
        self.radio10mm.setObjectName("radio10mm")
        self.gridLayout.addWidget(self.radio10mm, 2, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radio0_1mm.setText(_translate("MainWindow", "0,1mm"))
        self.radio1mm.setText(_translate("MainWindow", "1mm"))
        self.radio10mm.setText(_translate("MainWindow", "10mm"))
